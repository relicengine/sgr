...
# even escaped ones.
sources_project_68k_C				:= $(shell find $(path_project_68k_sources) -type f -regex ".*.c" | sed "s, ,$(space_character_delimiter),g")
sources_project_68k_ASM				:= $(shell find $(path_project_68k_sources) -type f -regex ".*.asm" | sed "s, ,$(space_character_delimiter),g")
...
objects_project_68k_C				:= $(addprefix $(shell echo $(path_project_68k_objects) | sed "s, ,$(space_character_delimiter),g")/, $(notdir $(sources_project_68k_C:.c=.c.o)))
objects_project_68k_ASM				:= $(addprefix $(shell echo $(path_project_68k_objects) | sed "s, ,$(space_character_delimiter),g")/, $(notdir $(sources_project_68k_ASM:.asm=.asm.o)))
